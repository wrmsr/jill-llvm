...
void JasminWriter::printProgram(const std::string &fname, const std::string &mName) {
...
void JasminWriter::printModule(const std::string &fname, const std::string &mName) {
  nl(Out) << "Module* " << fname << "() {";
