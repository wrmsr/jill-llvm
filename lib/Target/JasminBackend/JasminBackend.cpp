...
void JasminWriter::printVariableUses(const GlobalVariable *GV) {
...
void JasminWriter::printFunctionUses(const Function* F) {
...
void JasminWriter::printInline(const std::string& fname,
  ...
  printFunctionBody(F);
  is_inline = false;
  Out << "return " << getJasminName(&F->front()) << ";";
  nl(Out) << "}";
  nl(Out);
}
...
void JasminWriter::printContents(const std::string& fname,
                              const std::string& mName) {
...
void JasminWriter::printFunction(const std::string& fname,
  ...
  printFunctionHead(F);
  printFunctionBody(F);
  Out << "return " << getJasminName(F) << ";\n";
  Out << "}\n";
}

void JasminWriter::printFunctions() {
...
void JasminWriter::printVariable(const std::string& fname,
  ...
  printVariableHead(GV);
  printVariableBody(GV);
  Out << "return " << getJasminName(GV) << ";\n";
  Out << "}\n";
}

void JasminWriter::printType(const std::string &fname,
